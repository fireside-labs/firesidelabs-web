...
const papers: Paper[] = [
  ...
  },
  {
    ...
    date: 'May 2026',
    readTime: '12 min',
    pullQuote: 'The gap between the best local model and the best cloud model is only 5 points. The gap between two generations of Gemini Flash is 16 points. Most teams using cloud APIs have never measured which gap they are actually paying for.',
  },
  {
  ...
  },
  {
    ...
    date: 'May 2026',
    readTime: '14 min',
    pullQuote: 'A model that scores 89 on the leaderboard and 71 on stability-under-paraphrase is not the model your customers will experience as 89. The leaderboard is measuring a different product than the one you are about to ship.',
  },
  // ── TIER B · DEEPER ──
  {
    title: 'Local Vision AI: The Accuracy and Cost Case',
    description: 'A local 7B vision model outperforms Gemini Flash by 7–10 points on the task that matters, with $1,500–$30,000/month in savings depending on pipeline design. Plus the 9-point penalty from bundled prompts and the 30-point left/right phrasing asymmetry no production team accounts for.',
    tag: 'APPLIED RESEARCH',
    file: '/papers/Decomposed_Prompting_Vision_Pipelines.html',
    gated: false,
    date: 'May 2026',
    readTime: '15 min',
    pullQuote: 'Bundling two questions into one prompt cost the model 9 points of accuracy on questions it could answer when asked separately. Same model. Same image. Different prompt structure. Nine points.',
  },
  {
    title: 'Picking the Right Small Model for Empathy-Adjacent Production',
    description: 'Standard benchmarks will lead you to the wrong model for any customer-facing AI. Eight small open-weights models tested on 60 ranked-choice scenarios designed to surface two failure modes invisible on standard evals: decision instability under prompt reformulation, and cultural canon contamination from sitcom training data.',
    tag: 'CX RELIABILITY',
    file: '/papers/Picking_Small_Model_Empathy_Adjacent.html',
    gated: true,
    date: 'May 2026',
    readTime: '17 min',
    pullQuote: 'Top-1 accuracy converges in the 95–97% range across all 14B+ models. If you pick by accuracy alone, the modern small models look the same. They aren\'t.',
  },
  {
  ...
  // ── TIER C · METHODOLOGY & CREDIBILITY ──
  {
    ...
    date: 'May 2026',
    readTime: '16 min',
    pullQuote: 'Comparing models on benchmarks without standardized harness protocols is roughly equivalent to comparing them at different temperatures. Apples to oranges, dressed up as a leaderboard.',
  },
  {
    ...
    date: 'May 2026',
    readTime: '14 min',
    pullQuote: 'The value of narrow customization is inversely proportional to host capability. The Free Lunch hypothesis at 8B was real and reproducible. It does not generalize to 14B.',
  },
  {
    title: 'The Fireside Chimera Beats Both Parents',
    description: 'A narrow but mechanistically real demonstration that trained capability can be transferred between models via surgical layer grafts. The EXP6 chimera exceeds both parents on MMLU, 500Q, and GSM8K under matched clean-harness conditions. The deltas are modest. The principle is general.',
    tag: 'CAPABILITY COMPOSITION',
    file: '/papers/Chimera_Beats_Both_Parents.html',
    gated: false,
    date: 'May 2026',
    readTime: '11 min',
    pullQuote: 'Chimera-beats-both-parents is not an interpolation between parents. It exceeds the ceiling of both. The graft adds capability the parents individually cannot produce.',
  },
  {
    title: 'Where the Chimera Actually Wins',
    description: 'A per-question discriminative analysis of GSM8K shows where the EXP6 chimera advantage lives, and where it does not. The win zone concentrates sharply on multi-step money and percentage problems where the host model truncates calculation partway through.',
    tag: 'SURGICAL MECHANISM',
    file: '/papers/Where_the_Chimera_Actually_Wins.html',
    gated: false,
    date: 'May 2026',
    readTime: '12 min',
    pullQuote: 'The chimera does not make Llama better at single-step problems. It makes Llama better at the questions that require holding intermediate state across multiple computation steps.',
  },
  {
    title: 'A 3GB Model That Beats Your 14B Workstation AI',
    description: 'A 2-billion-effective-parameter Per-Layer Embeddings model (gemma-4-E2B) beats 14B vanilla dense models on multi-step bash workflows at one-third the VRAM. Capability-per-VRAM is dramatically non-monotonic. With honest scoping: E2B is narrow, sits well below 8B baselines on knowledge benchmarks.',
    tag: 'DEPLOYMENT ARCHITECTURE',
    file: '/papers/Per_Layer_Embeddings_Punch_Above_Weight.html',
    gated: false,
    date: 'May 2026',
    readTime: '13 min',
  ...
  },
  {
    ...
    description: 'Five small language models, four benchmarks, three replicate runs. At matched per-token compute, MoE and dense+PLE tie on single-question benchmarks; on multi-step bash workflows the matched-compute pair shows a 16.3pt first-try gap at 4σ confidence. Architecture choice depends on compute tier, not architecture family in the abstract.',
    tag: 'ARCHITECTURE COMPARISON',
    file: '/papers/When_MoE_Wins_When_Dense_PLE_Wins.html',
    gated: false,
    date: 'May 2026',
    readTime: '15 min',
    pullQuote: 'Total parameters is a memory metric. Per-token compute is a capability metric. Get the unit right before you start comparing architectures.',
  },
  {
    title: 'Why You Can\'t Shrink Gemma 4 or Qwen 3 the Easy Way',
    description: 'A negative result on cosine-merge surgery: experts in modern 128-expert top-8 MoE models (Gemma-4-26B, Qwen3-30B) are essentially orthogonal. Maximum pairwise cosine 0.053 and 0.010 respectively. No clusters form at any threshold ≥ 0.10. Weight-level approaches don\'t work on this architecture family; functional approaches remain viable.',
    tag: 'ARCHITECTURE RESEARCH',
    file: '/papers/MoE_Experts_Orthogonal.html',
    gated: false,
    date: 'May 2026',
    readTime: '11 min',
  ...
  {
    title: 'GGUF Identity Verification',
    description: 'We benchmarked three GGUF files with different names, ran experiments thinking we were testing novel architectures, and published results that were meaningless. SHA256 confirmed all three were identical. A practical guide to detecting silent duplicates and building model provenance into your benchmark pipeline.',
    tag: 'SUPPLY CHAIN',
    file: '/papers/GGUF_Identity_Verification.html',
    gated: false,
    date: 'May 2026',
    readTime: '9 min',
    pullQuote: 'We benchmarked three models with different names, ran experiments thinking we were testing novel architectures, and published results that were meaningless. They were all the same file.',
  },
  {
    title: 'Why Running the Same Benchmark Twice Gives You Different Numbers',
    description: 'A four-level reproducibility hierarchy and a working harness for getting reproducible inference numbers across hardware, drivers, and binary versions, validated on a 3-node cluster running 25 models.',
    tag: 'METHODOLOGY',
  ...
  },
  {
    ...
    description: 'Preliminary single-model observation: removing 5% of parameters from a 31B-parameter model produced no measurable accuracy loss across HumanEval, MMLU, and general knowledge benchmarks. Pending letter-shuffle contamination validation. To be superseded by the forthcoming Per-Graft Calibration Cost paper.',
    tag: 'APPLIED RESEARCH · PRELIMINARY',
    file: '/papers/Pruning_Free_at_5_Percent.html',
    gated: false,
    date: 'Apr 2026',
    readTime: '7 min',
    pullQuote: '5% smaller. 4% faster. Same accuracy on the benchmarks tested. We are publishing the observation but flagging the caveat: a single 31B model at a single quant level is not yet a finding.',
  },
];
